...
def main(argv):
	...
	apgrp.add_argument("-d", "--tbl-dump", action="store_true", help="dump TBL file list (specify fileList.txt)")
	apgrp.add_argument("-t", "--tbl-create", action="store_true", help="create TBL file (specify fileList.txt)")
